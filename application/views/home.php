...
<head>
  ...
  <link rel="preload" as="style" href="<?php echo base_url();?>assets/web/mobirise-icons/mobirise-icons.css">
<link rel="stylesheet" href="<?php echo base_url();?>assets/web/mobirise-icons/mobirise-icons.css">
  <link rel="preload" as="style" href="<?php echo base_url();?>assets/bootstrap/css/bootstrap.min.css">
<link rel="stylesheet" href="<?php echo base_url();?>assets/bootstrap/css/bootstrap.min.css">
  <link rel="preload" as="style" href="<?php echo base_url();?>assets/bootstrap/css/bootstrap-grid.min.css">
<link rel="stylesheet" href="<?php echo base_url();?>assets/bootstrap/css/bootstrap-grid.min.css">
  <link rel="preload" as="style" href="<?php echo base_url();?>assets/bootstrap/css/bootstrap-reboot.min.css">
...
<section class="mbr-section article content1 cid-rF7LIvYl8M" id="content1-3">
...
<section class="features6 cid-rF7LOt473P" id="features6-6">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                ...
                <div class="card-box">
                    ...
                    <p class="mbr-text mbr-fonts-style display-7">
                       Kami percaya bahwa dengan kebersamaan, kita dapat meraih capaian yang lebih besar. Dengan menggelorakan budaya berkolaborasi, kami sedang otw menuju ekosistem digital yang tidak hanya menyenangkan, tapi juga bisa diandalkan.
                    </p>
                </div>
            </div>
...
<section class="mbr-section content7 cid-rF7LLixhIa" id="content7-5">
                ...
                <div class="media-container-row">
                    <div class="media-content">
                        <div class="mbr-section-text">
                            <p class="mbr-text align-right mb-0 mbr-fonts-style display-7"><strong>TasikHub</strong> adalah tempat kami bersarang dan bertelur, disini kami membicarakan banyak hal, membangun banyak hal, untuk lingkungan yang lebih baik.<br><br>Find Us</p>
                        </div>
                    </div>
                    <div class="mbr-figure" style="width: 60%;">
                     <img src="<?php echo base_url();?>assets/images/whatsapp-image-2019-10-17-at-11.56.03-436x327.jpg" alt="Mobirise" title="">  
                    </div>
                </div>
            </div>
        </div>
...
<section class="cid-rF7M7Oappr" id="footer1-a">
        ...
        <div class="media-container-row content text-white">
            <div class="col-12 col-md-3">
                <div class="media-wrap">
                    <a href="https://tasikcode.xyz">
                        <img src="<?php echo base_url();?>assets/images/tasik-code-logo1-548x235.png" alt="Mobirise" title="">
                    </a>
                </div>
            </div>
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
                ...
                <p class="mbr-text">TasikHub<br>Jalan Gunung Sari No. 13,<br>Kota Tasikmalaya, Jawa Barat INDONESIA</p>
            </div>
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
                <h5 class="pb-3">
                    Contacts
                ...
                <p class="mbr-text">
                    Email: hai.tasikcode@gmail.com &nbsp;&nbsp;</p>
            </div>
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
                <h5 class="pb-3">
                    Links
        ...
        <div class="footer-lower">
            ...
            <div class="media-container-row mbr-white">
                <div class="col-sm-6 copyright">
                    <p class="mbr-text mbr-fonts-style display-7">
                        © Copyright 2019 TasikHub - All Rights Reserved
                    </p>
                </div>
                <div class="col-md-6">
                    <div class="social-list align-right">
                        <div class="soc-item">
                            <a href="https://twitter.com/tasikcode" target="_blank">
  ...
  <script src="<?php echo base_url();?>assets/web/<?php echo base_url();?>assets/jquery/jquery.min.js"></script>
  <script src="<?php echo base_url();?>assets/popper/popper.min.js"></script>
  <script src="<?php echo base_url();?>assets/bootstrap/js/bootstrap.min.js"></script>
  <script async src="<?php echo base_url();?>assets/tether/tether.min.js"></script>
  <script async src="<?php echo base_url();?>assets/dropdown/js/nav-dropdown.js"></script>
  <script async src="<?php echo base_url();?>assets/dropdown/js/navbar-dropdown.js"></script>
  <script async src="<?php echo base_url();?>assets/touchswipe/jquery.touch-swipe.min.js"></script>
  <script async src="<?php echo base_url();?>assets/parallax/jarallax.min.js"></script>
  <script async src="<?php echo base_url();?>assets/smoothscroll/smooth-scroll.js"></script>
  <script async src="<?php echo base_url();?>assets/theme/js/script.js"></script>
